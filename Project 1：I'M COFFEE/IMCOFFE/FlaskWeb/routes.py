...
from FlaskWeb.forms import LoginForm
from FlaskWeb.forms import RegisterationForm
from FlaskWeb.forms import UpdateAccountForm

from FlaskWeb import db
from FlaskWeb import app
from FlaskWeb import bcrypt
...
@app.route("/newsArea", methods=['GET', 'POST'])
def newsArea():

    return render_template('newsArea.html', title='newsArea')
